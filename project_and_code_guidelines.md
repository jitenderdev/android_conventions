...
```java
Picasso.with(context).load("http://google.com/images/sexyjoe.jpg").into(imageView);
```

```java
Picasso.with(context)
        .load("http://google.com/images/sexyjoe.jpg")
        .into(imageView);
```
...
```java
loadPicture(context, "http://google.com/images/sexyjoe.jpg", mImageViewProfilePicture, clickListener, "Title of the picture");
```

```java
loadPicture(context,
        "http://google.com/images/sexyjoe.jpg",
